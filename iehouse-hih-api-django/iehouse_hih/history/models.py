...
#     potencia_bombillo = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
#     hours_on = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
